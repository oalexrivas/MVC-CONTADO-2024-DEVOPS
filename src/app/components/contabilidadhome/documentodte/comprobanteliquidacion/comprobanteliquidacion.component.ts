...
@Component({
  ...
  templateUrl: './comprobanteliquidacion.component.html',
  styleUrls: ['./comprobanteliquidacion.component.css']
})
export class ComprobanteliquidacionComponent implements OnInit {
