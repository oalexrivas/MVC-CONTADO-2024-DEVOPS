...
@Component({
  ...
  templateUrl: './comprobanteretencion.component.html',
  styleUrls: ['./comprobanteretencion.component.css']
})
export class ComprobanteretencionComponent implements OnInit {
