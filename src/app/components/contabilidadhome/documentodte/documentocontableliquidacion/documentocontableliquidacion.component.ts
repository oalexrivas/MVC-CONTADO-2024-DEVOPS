...
@Component({
  ...
  templateUrl: './documentocontableliquidacion.component.html',
  styleUrls: ['./documentocontableliquidacion.component.css']
})
export class DocumentocontableliquidacionComponent implements OnInit {
