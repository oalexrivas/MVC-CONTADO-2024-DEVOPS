...
@Component({
  ...
  templateUrl: './facturasujetoexcluido.component.html',
  styleUrls: ['./facturasujetoexcluido.component.css']
})
export class FacturasujetoexcluidoComponent implements OnInit {
