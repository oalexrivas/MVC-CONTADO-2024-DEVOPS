...
@Component({
  ...
  templateUrl: './registroproductoservicio.component.html',
  styleUrls: ['./registroproductoservicio.component.css']
})
export class RegistroProductoservicioComponent implements OnInit {
