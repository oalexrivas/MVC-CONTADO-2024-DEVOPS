...
@Component({
  ...
  templateUrl: './registrotokenHacienda.component.html',
  styleUrls: ['./registrotokenHacienda.component.css']
})
export class RegistroTokenHaciendaComponent implements OnInit {
